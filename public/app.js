...
// keep existing state if your app already defines it
window.state = window.state || { kits: [], byId: new Map(), selected: new Set(), activeFilter: 'all' };

// fallback renderer (only used if your file doesn't define renderGrid)
window.renderGrid = window.renderGrid || function () {
